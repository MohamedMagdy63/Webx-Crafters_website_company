    ...
    <>
      ...
      <div className="min-h-screen">
        ...
        <div className="flex flex-col lg:flex-row justify-center lg:m-32 mt-32 mb-32 ">
          ...
          <div className={`w-full lg:w-3/4 p-4 text-lg ${language === 'En' ? 'text-justify':  'text-right'}  text-gray-800`}>
          {language === 'En' ?
            <p>
              At our company, 
          ...
          :  
            <p>
              ...
              نحن ملتزمون بتعزيز النمو وتعزيز النجاح في مشهد الإنترنت دائم التطور
            </p>
          }
          </div>
        </div>
