...
const Navbar = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full lg:p-5 sm:p-3 max-sm:p-4 transition-all duration-300 ${activeBg ? "bg-slate-200" : "bg-none"} z-50`}>
      <div className="w-full flex items-center relative z-10">
        <Link className="lg:w-[15%] sm:w-[15%] max-sm:w-[50%] lg:-mt-2" to='/'>
          <span className="lg:text-4xl sm:text-2xl max-sm:text-xlg font-bold bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent">
            W
          </span>
        ...
        <div className="w-[85%] flex justify-between items-center">
          ...
          <ul className='flex space-x-4 text-gray-500'>
            <Link to='/about' className="lg:text-2xl sm:text-xl max-sm:hidden font-mainFont font-bold px-3 hover:text-gray-800">About</Link>
            <Link to='/services' className="lg:text-2xl sm:text-xl max-sm:hidden font-mainFont font-bold px-3 hover:text-gray-800">Services</Link>
            <Link to='/projects' className="lg:text-2xl sm:text-xl max-sm:hidden font-mainFont font-bold px-3 hover:text-gray-800">Projects</Link>
          </ul>
