...
const MainSlide = () => {
  ...
  return (
    ...
    sm:flex sm:flex-col-reverse sm:justify-center sm:items-center">
      ...
      max-sm:w-[90%] max-sm:h-screen max-sm:flex max-sm:justify-center max-sm:items-center max-sm:z-10 max-sm:pt-10'>

        <div ref={textContainer} className='w-fit h-fit flex flex-col lg:justify-center lg:items-start lg:pl-[100px] sm:pl-0 sm:justify-start sm:items-start'>
          <div ref={designDiv} className='w-full text-start h-1 overflow-hidden'>
            <p ref={designEle} className='lg:text-7xl sm:text-5xl font-mainFont'>Design, <span ref={test} className='font-bold text-mainColor'>Develop</span></p>
          </div>
          ...
          <p ref={textSplit} className='lg:text-7xl sm:text-5xl sm:mt-6 max-sm:mt-6 max-sm:text-5xl font-mainFont'>Software <span className='font-bold text-mainColor'>Systems</span></p>
        </div>
      </div>
      <div className='lg:w-[60%] lg:h-screen sm:w-full sm:h-[50%] max-sm:w-[50%] max-sm:h-[50%] z-20'>
        <div className='w-full h-full flex lg:justify-start lg:items-center sm:justify-end sm:items-end'>
          <img 
          src="landingPage.png" 
          alt=""
          className='object-cover lg:w-full lg:h-[90%] sm:w-[80%]' />
        </div>
      </div>
      ...
      <div ref={container} className='absolute overflow-hidden bottom-0 w-full h-[100px] p-0  flex justify-evenly items-center'>
        <div ref={subdiv} className='flex justify-center items-center gap-4 w-[500px]'>
          <img src={Layout} className='w-16 h-16 p-1' alt="" />
          <p className="text-sm lg:text-2xl text-center">
            Unique Layout design
          </p>
        </div>
        <div ref={subdiv} className='flex justify-center items-center gap-4 w-[500px]'>
          <img src={Responsive} className='w-16 h-16 p-1' alt="" />
          <p className="text-sm lg:text-2xl text-center">
            Beautiful all Device Responsive
          </p>
        </div>
        <div ref={subdiv} className='flex justify-center items-center gap-4 w-[500px]'>
          <img src={TechnicalSupport} className='w-16 h-16 p-1' alt="" />
          <p className="text-sm lg:text-2xl text-center">
